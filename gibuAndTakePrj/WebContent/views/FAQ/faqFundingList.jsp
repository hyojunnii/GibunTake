...
<body>
	...
	<div id="title">FAQ
	 ...
	 <div style="border: 1px solid #72d09e; float: left; width: 80%; height:600px; padding:50px 0px 0px 0px;">                  
	    ...
	    <div id="page-area">
				<%if(currentPage != 1){%>
					<a href="/gibuAndTakePrj/faq/fundinglist?p=<%=currentPage-1%>"> &lt; </a>
				<%} %>
				<% for(int i = startPage; i <= endPage; ++i) {%>
					<%if(i == currentPage) {%>
						<a><%=i%></a>
					<%}else{ %>
						<a href="/gibuAndTakePrj/faq/fundinglist?p=<%=i%>"><%=i%></a>
					<%} %>
				<%} %>
	...
	<script>
    	$(function(){
    		$('.toggle').click(function(){
    			...
    			location.href='/gibuAndTakePrj/faq/detailfunding?num=' + num;
    		});
