...
<body>
	...
	<div id="title">문의하기
	 ...
	 <div style="border: 1px solid #72d09e; float: left; width: 80%; height:600px; padding:50px 0px 0px 0px;">                  
	    	...
	    	<form action="/gibuAndTakePrj/qa/answerpay" method="get">
	    	<button class="toggle">결제질문<button id="img">▽</button></button>
	    	<button class="toggle" id="toggle">결제질문<button id="img">▽</button></button>
	    	<button class="toggle" id="toggle">결제질문<button id="img">▽</button></button>
	    	<button class="toggle" id="toggle">결제질문<button id="img">▽</button></button>
	    	<button class="toggle" id="toggle">결제질문<button id="img">▽</button></button>
	    	</form>
